  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
      ...
      <div className="relative max-h-[90vh] w-full max-w-4xl overflow-y-auto rounded-2xl bg-white shadow-2xl">
        <button
          onClick={onClose}
          className="absolute right-4 top-4 z-10 rounded-full bg-white/80 p-2 text-text-muted hover:text-primary"
          >
            Close
          </button>

          <div className="flex flex-col md:flex-row">
            <div className="relative h-64 bg-background md:h-auto md:w-2/5">
              {project.image ? (
                <img
                  src={project.image}
                  alt={project.title}
            ...
            <div className="flex-1 p-6 sm:p-8">
              ...
              <div className="mb-8 grid gap-4 text-sm text-text-secondary sm:grid-cols-2">
                <div>
              ...
              <div className="mb-8 max-w-none">
                ...
                {project.description ? (
                  <SanitizedHtml
                    ...
                    className="whitespace-pre-wrap leading-relaxed text-text-secondary"
                  />
                ) : (
